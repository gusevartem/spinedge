...
export const About:FC<AboutProps> = () => {
    ...
    return (
        <div className='AboutSec' id="about" >
            <img src='./shum.webp' className='aboutShum1' />
            <img src='./shum.webp' className='aboutShum2' />
            <img src='./shum.webp' className='aboutShum3' />
            <div className='AboutGpt1' ></div>
            <div className='AboutGpt2' ></div>
            <img src='./shum.webp' className='aboutShum4' />
            ...
            <img src='./shum.webp' className='aboutShum5' />
            <img src='./shum.webp' className='aboutShum6' />
            <div className='AboutCenterShadow' ></div>
            <img src='./About/linesBg.webp' className='LinesBg' />
            <img src='./About/linesBg.webp' className='LinesBg2' />
            <img src='./About/figuraBg.png' className='FiguraBg' />
            <div className='AboutBody z-[4]' >
                <div className='FirstBlock' >
                    <div className='ImgWrap' >
                        <img src='./About/place.png' className='PlaceImg' />
                    </div>
                ...
                <div className='SecondBlock' >
                    <img src='./About/bgMob.png' className='FiguraBgMob' />
                ...
                <div className='relative' >
                        ...
                        <div className='ThirdRightBlock' >
                            <div className={`CompanyList CompanyList1`} >
                                {window.innerWidth < 1000 
                                    ? compaies.slice(0,5).map((item, ind) => <img key={ind} className='CompanyImg' src={item} />)
                                    : compaies.slice(0,4).map((item, ind) => <img key={ind} className='CompanyImg' src={item} />)
                                }
                            </div>
                            <div className='CompanyList CompanyList2' >
                                {window.innerWidth < 1000 
                                    ? compaies.slice(5,10).map((item, ind) => <img key={ind} className='CompanyImg' src={item} />)
                                    : compaies.slice(4,8).map((item, ind) => <img key={ind} className='CompanyImg' src={item} />)
                                }
                            </div>
                            <div className='CompanyList CompanyList3' >
                                {window.innerWidth < 1000 
                                    ? compaies.slice(10,12).map((item, ind) => <img key={ind} className='CompanyImg' src={item} />)
                                    : compaies.slice(8,12).map((item, ind) => <img key={ind} className='CompanyImg' src={item} />)
                                }
                            </div>
                        </div>
                    </div>
                    <div className='Founders' id="team" >
                        <span className='FoundersTitle' >founders: <img className='SlideImg' src='./slide.webp' /></span>
                        <div className='flex' >
                            <Swiper
                            ...
                            >
                                <SwiperSlide>
                                    <div className='FoundersListItem' >
                                        <div className='FoundersTopGroup'>
                                            <img src='./About/pers1.1.webp' className='FounderImg' />
                                ...
                                <SwiperSlide>
                                    <div className='FoundersListItem' >
                                        <div className='FoundersTopGroup'>
                                            <img src='./About/pers1.2.webp' className='FounderImg' />
                                            <div className='FounderInfo' >
                                ...
                                <SwiperSlide>
                                    <div className='FoundersListItem' >
                                        <div className='FoundersTopGroup'>
                                            <img src='./About/pers1.3.webp' className='FounderImg' />
                                            <div className='FounderInfo' >
                    ...
                    <div className='Founders' >
                        <span className='FoundersTitle gradient-text-green' >
                            team members:
                            <img className='SlideImg' src='./slide.webp' />
                        </span>
                        <div className='flex' >
                            <Swiper
                                slidesPerView={window.innerWidth < 910 ? 2.5 : 3}
                            ...
                            >
                                <SwiperSlide>
                                    <div className='FoundersListItem' >
                                        <div className='FoundersTopGroup'>
                                            <img src='./About/image2.1.png' className='FounderImg' />
                                            <div className='FounderInfo' >
                                ...
                                <SwiperSlide>
                                    <div className='FoundersListItem' >
                                        <div className='FoundersTopGroup'>
                                            <img src='./About/image2.2.png' className='FounderImg' />
                                            <div className='FounderInfo' >
                                ...
                                <SwiperSlide>
                                    <div className='FoundersListItem' >
                                        <div className='FoundersTopGroup'>
                                            <img src='./About/image2.3.png' className='FounderImg' />
                                            <div className='FounderInfo' >
                    ...
                    <div className='Founders' >
                        <span className='FoundersTitle' >advisors: <img className='SlideImg' src='./slide.webp' /></span>
                        <div className='AdvisorsAboutList' >
                            <SwiperSlide>
                                    <div className='FoundersListItem' >
                                        <div className='FoundersTopGroup'>
                                            <img src='./About/image3.1.png' className='FounderImg' />
                                            <div className='FounderInfo' >
                                ...
                                <SwiperSlide>
                                    <div className='FoundersListItem' >
                                        <div className='FoundersTopGroup'>
                                            <img src='./About/image3.2.png' className='FounderImg' />
                                            <div className='FounderInfo' >
                                ...
                                <SwiperSlide>
                                    <div className='FoundersListItem' >
                                        <div className='FoundersTopGroup'>
                                            <img src='./About/image3.3.png' className='FounderImg' />
                                            <div className='FounderInfo' >
                                ...
                                <SwiperSlide>
                                    <div className='FoundersListItem' >
                                        <div className='FoundersTopGroup'>
                                            <img src='./About/image3.4.png' className='FounderImg' />
                                            <div className='FounderInfo' >
