...
export const Cases:FC<CasesProps> = () => {
    ...
    return (
        <div className='CasesSec' id="cases" >
            <img src='./shum.webp' className='caseShum1' />
            <img src='./shum.webp' className='caseShum2' />
            <img src='./shum.webp' className='caseShum3' />
            <img src='./shum.webp' className='caseShum4' />
            <img src='./shum.webp' className='caseShum5' />
