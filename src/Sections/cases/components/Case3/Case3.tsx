    ...
    return (
        <div className='Case3Block' >
            ...
            <div className='Case3CaseBody' >
                ...
                <img loading='lazy' data-src='./Cases/corner.png' className='Case3Corner1' />
                <img loading='lazy' data-src='./Cases/corner.png' className='Case3Corner2' />
                ...
                <div className='Case3ImagesGroup' >
                    <img loading='lazy' data-src='./Case3/img1.webp' className='Case3Img1' />
                    <img loading='lazy' data-src='./Case3/img2.webp' className='Case3Img2' />
                    <img loading='lazy' data-src='./Case3/imgMob.webp' className='Case3Img2Mob' />
                </div>
