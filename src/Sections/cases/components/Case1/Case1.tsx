    ...
    return (
        <div className='Case1Block' >
            ...
            <div className='CaseBody' >
                ...
                <img src='./Cases/corner.png' className='Case1Corner1' />
                <img src='./Cases/corner.png' className='Case1Corner2' />
                ...
                <div className='Case1ImagesGroup' >
                    <div className='DiagramaWrap' >
                        <img src='./Case1/img1.webp' className='Case1Img1' />
                        <img src='./Case1/imgMob.webp' className='Case1ImgMob' />
                        <img src='./Case1/img2.webp' className='Case1Img2' />
                        <div className='Case1Upto mono' >
                            up to 1000 tops/w <br /> efficiency
                            <div className='Case1Tri' />
                        </div>
                        <img src='./Case1/diagrama.webp' className='Diagrama' />
                    </div>
                </div>
            </div>
        </div>
