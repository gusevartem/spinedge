    ...
    return (
        <div className='Case2Block' >
            ...
            <div className='CaseBody' >
                ...
                <img src='./Cases/corner.png' className='Case2Corner1' />
                <img src='./Cases/corner.png' className='Case2Corner2' />
                ...
                <div className='Case2ImagesGroup' >
                    <img src='./Case2/drone.webp' className='Drone' />
                    <img src='./Case2/droneMob.webp' className='DroneMob' />
                    <img src='./Case2/car1.webp' className='Case2Car1' />
                    <img src='./Case2/car1Mob.png' className='Case2Car1Mob' />
                    <img src='./Case2/car2.png' className='Case2Car2' />
                    <img src='./Case2/car2Mob.png' className='Case2Car2Mob' />
                    <div className='Case2CenterImgWrap' >
                        <img src='./Case2/line1.webp' className='Case2Line1' />
                        <img src='./Case2/line2.webp' className='Case2Line2' />
                        <img src='./Case2/line3.webp' className='Case2Line3' />
                        <AnimatedCircle id={''} lottieRef={circleRef} customStyle={`Case2Spin`} width={80} height={80} />
                        <img src='./Case2/lineTopMob.webp' className='Case2Line1Mob' />
                        <img src='./Case2/lineRightMob.webp' className='Case2Line2Mob' />
                        <img src='./Case2/lineLeftMob.webp' className='Case2Line3Mob' />

                        <img src='./Case2/plata.webp' className='Case2Plata' />
                    </div>
                </div>
